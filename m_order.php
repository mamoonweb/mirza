...
if(isset($_POST['btno'])){
	...
	$show=mysqli_query($con,"insert into `order` values('','$fullname','$email','$phone','$address','$quantity','$foodn','$price','$totalp',now())") or die (mysqli_error());
...
<table width="80%" border="0" cellspacing="10" class="table table-responsive ">
  ...
  <tr>
    <td>Food Name</td>
    <?php
	 $sql=mysqli_query($con,"select * from `specialfood` where id='$mid'") or die (mysqli_error());
...
<tr>
 ...
 <input type="text" readonly id="tprice" name="totalp" value="" class="form-control" style="width:300px">
  ...
  <tr>
    <td>&nbsp;</td>
    <td><input type="submit" name="btno" value="Order"  class="btn btn-info btn_c" ></td>
  </tr>
